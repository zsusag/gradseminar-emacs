...
architectures without having to modify the bulk of the functionality written in Elisp.
...
interfaces to PDF viewers, web browsers to email clients --- even [[https://github.com/ch11ng/exwm][a
