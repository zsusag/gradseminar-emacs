...
* Org-mode links
:PROPERTIES:
:ID:       30a81a92-15d6-4449-a90a-57ca838fe309
:END:
...
it into a link.
[[file:~/temp/readme.txt::Hello][The example file for Magit]]
...
[[http://www.meetup.com/Denver-Emacs-Meetup/][The Denver Emacs Meetup Group]]

[[http://writequit.org][Writequit site]]

[[http://google.com][Google's web site]]
...
:PROPERTIES:
:ID:       3ee760d6-49d9-4083-bdc2-1dd666fcb372
:END:
